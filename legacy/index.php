...
<body id="page-top">
  ...
  <header class="masthead d-flex parallax">
    <div class="container text-center my-auto">
      <h1 class="mb-1">GAL AFIK</h1>
      <h3 class="mb-5">
        <em>Software Engineer | Game Developer</em>
      </h3>
      <a class="btn btn-primary btn-xl" href="./resources/resume/Gal_Phillip_Afik_Software_Engineer_CV.pdf" target="_blank">My Resume</a>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
          ...
          <p class="text-faded mb-0">While most of my work is proprietary and can't be shared, some of my personal projects are available on the web! Check out my work on <b><a href="https://github.com/GalAfik" target="_blank" style="color: black;">GitHub</a></b> to see some of my coding samples.</p>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-5 mb-md-0">
          ...
          <p class="text-faded mb-0">I have worked on everything from personal projects (including this site) to development efforts for <b style="color: black;">Snyder's Pretzels</b>, <b style="color: black;">Dixon Valve</b>, and <b style="color: black;">Smithsonian Institute</b>.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9 mx-auto">
          ...
          <h4 class="position-title">Web Development Intern</h4>
          <h4 class="position-dates">Jun 2013 - Dec 2013</h4>
          <ul>
  ...
  <section id="runaway-robot" class="project-showcase-dark">
    <div class="project-showcase-text">
      ...
      <p class="lead mb-10">
        ...
        <h4>✸<b><i>GMTK 2020 Game Jam: 225th Place</i></b>✸</h4>
      <p class="lead mb-5">
  ...
  <section id="prepare-to-repair" class="project-showcase">
    <div class="project-showcase-text">
      <h2>Prepare to Re-Pair!</h2>
      <p class="lead mb-10">
        <b>Platform:</b> PC
        <b>Engine:</b> Unity <br/>
        <b>Genre:</b> Puzzle
      ...
      <p class="lead mb-5">This game is my submission to the Global Game Jam 2020, hosted by Imangi Studios. The theme was "Repair". Prepare to Re-Pair!" is the story of two lonely magnets, lost in the world and searching for love. Players will race against the clock to reach their electrically charged buddies! Navigate mazes and solve puzzles to find your pair "re-pair" your friendship!</p>
  ...
  <div class="box">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="box-part text-center">
            <img class="shader-images" src="img/shaders/dissolve.gif">
          </div>
        </div>   
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="box-part text-center">
            <img class="shader-images" src="img/shaders/glow.gif">
          </div>
        </div>   
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="box-part text-center">
            <img class="shader-images" src="img/shaders/hologram.gif">
          </div>
        </div>   
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="box-part text-center">
            <img class="shader-images" src="img/shaders/shield.gif">
          </div>
        </div>   
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="box-part text-center">
            <img class="shader-images" src="img/shaders/snow.gif">
          </div>
        </div>   
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="box-part text-center">
            <img class="shader-images" src="img/shaders/water.gif">
          </div>
        </div>
      </div>    
    </div>
  ...
  <footer class="footer text-center">
    <div class="container">
      <h2 id="social-header">Connect with me online!</h2>
      <ul class="list-inline mb-5">
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white mr-3" href="https://www.facebook.com/gal.afik.9" target="_blank">           <i class="icon-social-facebook"></i>
          </a>
        </li>
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white mr-3" href="https://www.linkedin.com/in/galafik/" target="_blank">            <i class="icon-social-linkedin"></i>
          </a>
        </li>
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white" href="https://github.com/GalAfik" target="_blank">           <i class="icon-social-github"></i>
          </a>
        </li>
      </ul>
